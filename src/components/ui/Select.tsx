...
export function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      className={cn(
        'flex h-8 w-full items-center justify-between gap-2 rounded-(--radius-control)',
        'border border-hairline bg-surface-2 px-2.5 text-[13px] text-ink',
...
export function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      className={cn(
        'relative flex cursor-default select-none items-center gap-2 py-1.5 pl-7 pr-3 text-[13px] text-ink-dim outline-none',
