  ...
  return (
    <>
      <article className="panel group relative flex h-full flex-col gap-2 p-3 transition-colors duration-150 hover:border-hairline-strong">
        ...
        <p className="line-clamp-2 min-h-8 text-xs leading-4 text-ink-dim">
          {project.description || <span className="italic text-ink-faint">No description</span>}
        </p>

        <div className="flex min-w-0 items-center gap-2">
          <TypeBadge type={project.datasetType} />
          <span className="inline-flex min-w-0 items-center gap-1 rounded-(--radius-control) border border-hairline px-1.5 py-px text-[10px] text-ink-dim">
            <Cpu className="size-3 shrink-0 text-ink-faint" aria-hidden="true" />
