...
function PaletteItem({
  ...
  return (
    <Command.Item
      ...
      onSelect={onSelect}
      className={cn(
        'flex cursor-default select-none items-center gap-2.5 rounded-(--radius-control) px-2.5 py-1.5 text-[13px] text-ink-dim',
      ...
      >
        <Command label="Command palette" loop>
          ...
          <Command.List className="max-h-80 overflow-y-auto overscroll-contain p-1.5">
            <Command.Empty className="py-10 text-center text-xs text-ink-faint">
          ...
          <div className="flex items-center gap-4 border-t border-hairline px-3 py-2 text-[11px] text-ink-faint">
