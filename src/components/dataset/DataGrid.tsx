...
const Row = memo(function Row({
  ...
  return (
    ...
    >
      ...
      <div
        role="gridcell"
        className="truncate text-right font-mono text-[11px] tabular-nums text-ink-faint"
      >
        {index + 1}
      </div>
      <div role="gridcell">
      ...
      <div role="gridcell" className="min-w-0 truncate text-xs">
        {preview.user ? (
      ...
      <div
        role="gridcell"
        className="text-right font-mono text-[11px] tabular-nums text-ink-dim"
      >
        {e.messages.length}
      </div>
      <div
        role="gridcell"
        className="truncate text-right font-mono text-[11px] tabular-nums text-ink-dim"
      >
      ...
      <div role="gridcell" className="flex justify-center">
        <span
          className={cn(
            'rounded-(--radius-control) border px-1 font-mono text-[10px]',
            splitChip.cls,
          )}
          title={e.split}
        >
      ...
      <div role="gridcell" className="flex items-center justify-center gap-1">
        {e.flagged && (
          <Flag role="img" aria-label="Flagged" className="size-3 text-danger" />
        )}
        {e.reviewed && (
          <Check role="img" aria-label="Reviewed" className="size-3 text-ok" />
        )}
      </div>
      <div role="gridcell" className="truncate font-mono text-[10px] text-ink-faint">
  ...
  return (
    ...
    >
      <div
        ...
        className={cn(
          GRID_TEMPLATE,
          'sticky top-0 z-10 h-8 border-b border-l-2 border-hairline border-l-transparent bg-surface',
        )}
      >
