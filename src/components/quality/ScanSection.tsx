    ...
    <section className="panel animate-rise" style={style}>
      ...
      {phase === 'saving' && (
        <div className="flex items-center gap-2 border-b border-hairline px-3 py-2">
          ...
          <span className="w-10 text-right font-mono text-[11px] tabular-nums text-ink-faint">
      ...
      {stats.scored === 0 ? (
        ...
        <>
          ...
          {issueRows.length === 0 ? (
            <p className="flex items-center gap-1.5 border-t border-hairline px-3 py-2.5 text-xs text-ok">
              ...
              <tbody>
                {issueRows.map((row) => (
                  <tr key={row.type} className="border-b border-hairline last:border-b-0">
                    <td className="px-3 py-1.5 font-mono text-xs text-ink">{row.type}</td>
                    <td className="py-1.5">
