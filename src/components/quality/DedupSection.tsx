    ...
    <section className="panel animate-rise" style={style}>
      ...
      {results && (
        <div className="border-t border-hairline">
          {groups.length === 0 ? (
            <p className="flex items-center gap-1.5 px-3 py-2.5 text-xs text-ok">
              <CheckCircle2 className="size-3.5 shrink-0" aria-hidden="true" />
              No duplicates found at this threshold.
            </p>
          ) : (
            <>
              <div className="flex flex-wrap items-center gap-x-4 gap-y-1 px-3 py-2 text-xs text-ink-dim">
                <span>
              ...
              {shown.map((group) => (
                ...
                >
                  ...
                  <span className="w-10 shrink-0 text-right font-mono text-[11px] tabular-nums text-ink">
              ...
              {groups.length > MAX_GROUPS_SHOWN && (
                <p className="border-t border-hairline px-3 py-1.5 font-mono text-[11px] tabular-nums text-ink-faint">
              ...
              <div className="flex justify-end border-t border-hairline px-3 py-2">
                <Button
                  ...
                  disabled={busy !== 'idle'}
                >
                  {busy === 'remove' ? <Spinner className="size-3" /> : <Trash2 />}
