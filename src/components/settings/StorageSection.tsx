    ...
    <div className="panel divide-y divide-hairline">
      <div className="px-3 py-2.5">
        <div className="flex items-baseline justify-between gap-3">
          <span className="text-[13px] text-ink">IndexedDB usage</span>
          {estimate ? (
      ...
      <div className="flex items-center justify-between gap-3 px-3 py-2.5">
        <div className="min-w-0">
          <div className="text-[13px] text-ink">Persistence</div>
        ...
        {persisted === null ? (
          <span className="shrink-0 text-xs text-ink-faint">Checking…</span>
        ) : persisted ? (
      ...
      <div className="flex items-center justify-between gap-3 px-3 py-2.5">
        <div className="min-w-0">
          <div className="text-[13px] text-ink">AI response cache</div>
          <p className="text-xs text-ink-dim">
