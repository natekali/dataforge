  ...
  return (
    <section className="panel">
      <div className="panel-header">
        ...
        <span className="text-[11px] text-ink-faint">Creates new examples in this project.</span>
      </div>
      <div className="flex flex-col gap-3 p-3">
        ...
        >
          {TECHNIQUES.map((t) => {
            ...
            return (
              ...
              >
                <span
                  className={cn('block text-xs font-medium', active ? 'text-accent' : 'text-ink')}
                >
                  {t.name}
                </span>
        ...
        <div className="flex items-center gap-3">
          ...
          >
            {busy ? <Spinner className="size-3 border-accent-ink/30 border-t-accent-ink" /> : <Sparkles />}
            Generate
          </Button>
        </div>
