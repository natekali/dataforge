...
export type Dtype = "F64" | "F32" | "C64" | "F16" | "F8_E4M3" | "F8_E4M3FNUZ" | "F8_E5M2" | "F8_E5M2FNUZ" | "F8_E8M0" | "E8M0" | "F6_E3M2" | "F6_E2M3" | "F4" | "FP4" | "BF16" | "I64" | "U64" | "I32" | "U32" | "I16" | "I8" | "U16" | "U8" | "UE8" | "BOOL";
 ...
 */
export declare function globMatch(pattern: string, str: string): boolean;
/**
 ...
 */
export declare function isQuantizedTensor(tensorName: string, quantConfig?: QuantizationConfig): boolean;
/**
 * @internal
 ...
 */
export declare function matchesCompressedTensorsTarget(target: string, moduleName: string): boolean;
export {};
